...
class CrossoriginLocalesPlugin extends BasePlugin
{
    /**
    ...
    {
         return Craft::t('Cross-Origin Locales');
    }
    ...
    {
        return Craft::t('Workaround for localized, cross-origin sites.');
    }
    ...
    {
        return 'https://github.com/timkelty/crossoriginlocales/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/timkelty/crossoriginlocales/master/releases.json';
    }
    ...
    {
       return craft()->templates->render('crossoriginlocales/CrossoriginLocales_Settings', array(
